        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0 action-area">
            ...
            <li class="nav-item dropdown language-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    ...
                    <a class="dropdown-item d-flex" href="javascript:void(0);">
                        <img src="{{Vite::asset('resources/images/1x1/th.svg')}}" class="flag-width" alt="flag">
                        <span class="align-self-center">&nbsp;Thai</span>
                    </a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);">
                        <img src="{{Vite::asset('resources/images/1x1/vn.svg')}}" class="flag-width" alt="flag">
                        <span class="align-self-center">&nbsp;Vietnamese</span>
                    </a>
                </div>
            </li>
