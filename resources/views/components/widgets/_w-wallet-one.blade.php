...
<div class="widget widget-wallet-one">
    ...
    <div class="wallet-action text-center d-flex justify-content-around">
        ...
        <button class="btn btn-success">
            ...
            <span class="btn-text-inner">Debit</span>
        </button>
    ...
    <ul class="list-group list-group-media">
        <li class="list-group-item">
            <div class="media">
                <div class="me-3">
                    <!-- Inline SVG placeholder for Deposit (a black circle) -->
                    <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="20" cy="20" r="18" fill="black" />
                    </svg>
                </div>
                <div class="media-body">
                    <h6 class="tx-inverse">Deposit</h6>
        ...
        <li class="list-group-item">
            <div class="media">
                <div class="me-3">
                    <!-- Inline SVG placeholder for Payout Withdrawal (a black circle) -->
                    <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="20" cy="20" r="18" fill="black" />
                    </svg>
                </div>
                <div class="media-body">
                    <h6 class="tx-inverse">Payout</h6>
